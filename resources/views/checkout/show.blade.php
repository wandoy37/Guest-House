...
@section('title')
    Check-Out Information - {{ $booking->id }}
@endsection
...
@section('content')
    ...
    <div class="page-content">
        <div class="row py-2">
            ...
            <div class="col-md-12">
                <a href="{{ route('check.out') }}" class="btn btn-primary mb-4">
                    Back
                </a>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="card">
                        ...
                        <div class="row py-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="{{ $booking->checkin_format }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="{{ $booking->checkout_format }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-footer">
                        <div class="float-end">
                            <!-- Tombol Checkout -->
                            <button type="button" class="btn btn-outline-primary btn-checkout"
                                data-id="{{ $booking->id }}">
                                Check-Out
                            </button>

                            <!-- Form checkout disembunyikan -->
                            <form id="checkout-form-{{ $booking->id }}"
                                action="{{ route('check.out.booking', $booking->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('PATCH')
                            </form>
