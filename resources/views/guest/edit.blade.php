            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Edit guest</h3>
                        <p class="text-subtitle text-muted">Edit tamu</p>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('type') is-invalid @enderror"
                                                    id="basicSelect" name="type">
                                                    <option value="">-- Select --</option>
                                                    <option value="KTP" @selected(old('type', $guest->type ?? '') == 'KTP')>KTP</option>
                                                    <option value="SIM" @selected(old('type', $guest->type ?? '') == 'SIM')>SIM</option>
                                                    <option value="PASPOR" @selected(old('type', $guest->type ?? '') == 'PASPOR')>PASPOR</option>
                                                </select>
                                                @error('type')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Name" value="{{ old('name', $guest->name) }}">
                                                @error('name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="3">{{ old('address', $guest->address) }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="basicInput">Email address</label>
                                                <input type="text"
                                                    class="form-control @error('email') is-invalid @enderror" name="email"
                                                    placeholder="Email address" value="{{ old('email', $guest->email) }}">
                                                @error('email')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Phone number" value="{{ old('phone', $guest->phone) }}">
                                                @error('phone')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
